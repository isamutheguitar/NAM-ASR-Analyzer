...
This analyzer was successfully utilized to verify the performance of `NAM-Oversampler v1.5.2` (by Carmelo Di Lio / DLC86), showing a direct correlation between the oversampling factor and ASR improvement:
...
| NAM OS v1.5.2 (16x, Minimum Phase) | **-62.10 dB** | Aliasing is fully pushed down to the noise floor, matching A1. |
